...
@implementation CuvoPromiseWrapper
...
-(void)reject:(NSString *)message withCode:(NSString*) errorCode withError:(NSError *)error {
    ...
    NSString* errorMessage = [NSString stringWithFormat:@"CuvoPromiseWrapper: %@, %@", message, error.description];
