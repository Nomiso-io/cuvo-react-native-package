...
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
  ...
  var CuvoAudioRecorderPlayer = NativeModules.CuvoAudioRecorderPlayer;
    ...
    function AudioRecorderPlayer() {
        ...
        this.addRecordBackListener = function (e) {
            if (Platform.OS === 'android') {
                ...
                var myModuleEvt = new NativeEventEmitter(CuvoAudioRecorderPlayer);
        ...
        this.startRecorder = function (uri, audioSets, meteringEnabled) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this._isRecording) {
                    ...
                    console.log('this._isRecordingthis._isRecordingthis._isRecording',this._isRecording);
                    return [2 /*return*/, CuvoAudioRecorderPlayer.startRecorder(uri !== null && uri !== void 0 ? uri : 'DEFAULT', meteringEnabled !== null && meteringEnabled !== void 0 ? meteringEnabled : false, audioSets)];
                }
        ...
        this.stopRecorder = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (this._isRecording) {
                    ...
                    return [2 /*return*/, CuvoAudioRecorderPlayer.stopRecorder()];
                }
        ...
        this.resumePlayer = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (this._hasPaused) {
                    ...
                    return [2 /*return*/, CuvoAudioRecorderPlayer.resumePlayer()];
                }
        ...
        this.stopPlayer = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (this._isPlaying) {
                    ...
                    this._hasPaused = false;
                    return [2 /*return*/, CuvoAudioRecorderPlayer.stopPlayer()];
                }
        ...
        this.pausePlayer = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (!this._hasPaused) {
                    ...
                    return [2 /*return*/, CuvoAudioRecorderPlayer.pausePlayer()];
                }
                return [2 /*return*/];
            });
        }); };
        ...
        this.seekToPlayer = function (time) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, CuvoAudioRecorderPlayer.seekToPlayer(time)];
            });
        }); };
        /**
         * set volume.
        ...
        this.setVolume = function (volume) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, CuvoAudioRecorderPlayer.setVolume(volume)];
            });
        }); };
        /**
        ...
        this.setSubscriptionDuration = function (sec) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, CuvoAudioRecorderPlayer.setSubscriptionDuration(sec)];
            });
        }); };
    }
