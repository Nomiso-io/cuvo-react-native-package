...
export declare function takeCamera(options: String, callback: Callback): void;
export declare function startScreenRecording(options: String): void;
export declare function stopVideoRecording(callback: Callback): void;
export declare function startAudioPlay (audioPath: String): Promise<void>;
export declare function stopAudioPlay (): void;
export declare function createAudioPlayer(): Promise<void>;
export declare function stopAudioPlay (): void;
export declare function startAudioRecording (): void;
export declare function stopAudioRecording (): Promise<void>;
